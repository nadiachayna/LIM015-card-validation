const validator = {
    isValid(crediCard) {
        ...
        //console.log(arreglo);
        //sumamos los numeros  >= 10 y le restamos nueve,que será lo mismo que la suma de ambos digitos
    ...
    maskify(numero) {
        //aplicamos el método array.from, me permite crear una nueva instancia de array 
